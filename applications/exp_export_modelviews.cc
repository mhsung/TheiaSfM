...
DEFINE_string(input_data_type, "",
              "'pose', 'modelview', or 'reconstruction'");
...
int main(int argc, char* argv[]) {
  ...
  CHECK(ReadModelviews(
      FLAGS_input_data_type, FLAGS_input_filepath, &modelviews));

  WriteModelviews(FLAGS_output_filepath, modelviews);
}
